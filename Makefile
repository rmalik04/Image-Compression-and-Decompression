...
# File name: Makefile
#
# This file contains all the rules for compiling the program into an
# executable file.
#
##############################################################################
...
arith: 40image.o uarray2.o uarray2b.o a2plain.o a2blocked.o arithio.o \
		 compressor.o decompressor.o calculations.o compress40.o \
		 new_pnm.o bitpack.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
